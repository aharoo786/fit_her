...
class HomeRepo extends GetxService {
  ...
  Future<Response> getClients(
      {required String accessToken, required String userId}) async {
    return await apiProvider.getData("${Constants.getClients}/$userId",
        headers: {"accessToken": accessToken});
  }
  ...
  Future<Response> getTimesOfDiet(
      {required String accessToken, required String userId}) async {
    return await apiProvider
        .getData(Constants.dietTimes, headers: {"accessToken": accessToken});
  }
  ...
  Future<Response> getDaySlots(
    ...
    return await apiProvider.postData(Constants.dietTimes,
        headers: {"accessToken": accessToken}, body: map);
  }
  ...
  Future<Response> getDietPdfRepo(
      {required String accessToken,
      required String planId,
      required String userId}) async {
    return await apiProvider.postData(Constants.getDietPdf,
        body: {"userId": userId, "userPlanId": planId},
        headers: {"accessToken": accessToken});
  }
  ...
  Future<Response> getSlotStatus(
      {required String accessToken, required int slotId}) async {
    return await apiProvider.getData("/admin/slot/$slotId/status",
        headers: {"accessToken": accessToken});
  }
  ...
  Future<Response> getAllUsers(
    ...
    if (isCustomerSupport) {
      return await apiProvider.getData(
          "${Constants.getAllUserWithSpecificCustomer}/${userId}",
          headers: {"accessToken": accessToken});
    } else {
      return await apiProvider.getData(Constants.getAllUsers,
          headers: {"accessToken": accessToken});
    }
  }
  ...
  Future<Response> addFreeTrialUser(
  ...
  Future<Response> savePcosScreening(
      {required String accessToken, required Map<String, dynamic> body}) async {
    return await apiProvider.postData(Constants.savePcosScreening,
        body: body, headers: {"accessToken": accessToken});
  }

  Future<Response> saveHealthScreening(
      {required String accessToken, required Map<String, dynamic> body}) async {
    return await apiProvider.postData(Constants.saveHealthScreening,
        body: body, headers: {"accessToken": accessToken});
  }

  Future<Response> getHealthScreening(
      {required String accessToken, String? conditionType}) async {
    final query = conditionType != null ? '?conditionType=$conditionType' : '';
    return await apiProvider.getData('${Constants.getHealthScreening}$query',
        headers: {"accessToken": accessToken});
  }
  ...
  Future<Response> getDirectPayPaymentUrl(
      {required String accessToken, required Map<String, dynamic> map}) async {
    return await apiProvider.postData(Constants.directPayUrl,
        body: map, headers: {"accessToken": accessToken});
  }
  ...
  Future<Response> addCountry(
      {required String accessToken, required Map<String, dynamic> map}) async {
    return await apiProvider.postData(Constants.country,
        body: map, headers: {"accessToken": accessToken});
  }

  Future<Response> addTimeDuration(
      {required String accessToken, required Map<String, dynamic> map}) async {
    return await apiProvider.postData(Constants.timeDuration,
        body: map, headers: {"accessToken": accessToken});
  }

  Future<Response> getCountries({required String accessToken}) async {
    return await apiProvider
        .getData(Constants.country, headers: {"accessToken": accessToken});
  }

  Future<Response> getTmeDurations({required String accessToken}) async {
    return await apiProvider
        .getData(Constants.timeDuration, headers: {"accessToken": accessToken});
  }

  Future<Response> addTrainerSlots(
      {required String accessToken, required Map<String, dynamic> map}) async {
    return await apiProvider.postData(Constants.add_slots,
        body: map, headers: {"accessToken": accessToken});
  }
  ...
  Future<Response> addPdfFileRepo(
      {required String accessToken, required Map<String, dynamic> map}) async {
    return await apiProvider.setFormData(
        url: Constants.addPdfFile,
        formData: map,
        headers: {"accessToken": accessToken});
  }

  Future<Response> addDaySlots(
      {required String accessToken, required Map<String, dynamic> map}) async {
    return await apiProvider.postData(
        "${Constants.dietTimes}/addOrUpdateDaySlot",
        body: map,
        headers: {"accessToken": accessToken});
  }
  ...
  Future<Response> addReview(
      {required String accessToken, required Map<String, dynamic> map}) async {
    return await apiProvider.postData(Constants.addReview,
        body: map, headers: {"accessToken": accessToken});
  }

  Future<Response> bookAppointment(
      {required String accessToken, required Map<String, dynamic> map}) async {
    return await apiProvider.postData("/appointment",
        body: map, headers: {"accessToken": accessToken});
  }
  ...
  Future<Response> startTrial(
      {required String accessToken, String? token}) async {
    return await apiProvider.postData(
  ...
  Future<Response> addCalorieImage(
      ...
      required Map<String, dynamic> map,
      required String id}) async {
    return await apiProvider.postData("${Constants.addCalorieImage}/$id",
        body: map, headers: {"accessToken": accessToken});
  }

  /// Motivation module
  Future<Response> getMotivationStats(
      {required String accessToken, required String userId}) async {
    return await apiProvider.getData("${Constants.getMotivationStats}/$userId",
        headers: {"accessToken": accessToken});
  }

  Future<Response> markMotivationAttendance(
      {required String accessToken,
      required String userId,
      required Map<String, dynamic> map}) async {
    return await apiProvider.postData(
        "${Constants.markMotivationAttendance}/$userId",
        body: map,
        headers: {"accessToken": accessToken});
  }

  Future<Response> classPresenceJoin(
      {required String accessToken, required Map<String, dynamic> map}) async {
    return await apiProvider.postData(Constants.classPresenceJoin,
        body: map, headers: {"accessToken": accessToken});
  }

  Future<Response> classPresenceLeave(
      {required String accessToken, required Map<String, dynamic> map}) async {
    return await apiProvider.postData(Constants.classPresenceLeave,
        body: map, headers: {"accessToken": accessToken});
  }

  /// Post-related APIs
  Future<Response> getAllPosts(
      {required String accessToken, bool approved = true}) async {
    return await apiProvider.getData("${Constants.getAllPosts}$approved",
        headers: {"accessToken": accessToken});
  }
  ...
  Future<Response> getPreConsultationProfile(
      {required String accessToken}) async {
    return await apiProvider.getData(
  ...
  Future<Response> bookConsultation({
    ...
    required Map<String, dynamic>
        body, // {date, userId, dietitionId, timeSlotId, userPlanId, kind}
  }) async {
    return await apiProvider.postData(
      "/appointment",
      body: body,
  ...
  Future<Response> upsertMealLog({
    required String accessToken,
    required Map<String, dynamic>
        body, // {date, mealType, status, reasonCode?, alternativeText?}
  }) async {
    return await apiProvider.postData(
      Constants.mealLogs,
      body: body,
  ...
  Future<Response> adminGetMetricsOverview(
      {required String accessToken}) async {
    return await apiProvider.getData(
