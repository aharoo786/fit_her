...
class AddPlanDiet extends StatelessWidget {
  AddPlanDiet({super.key, this.isFromUpdate = false});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Obx(() => homeController.selectedId.value == 2
                  ? Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(
                  ...
                  onPressed: () {
                    if (homeController.packageName.text.isEmpty ||
                      ...
                      if (isFromUpdate) {
                        ...
                        homeController.addDietitionPlan();
                      }
                    }
                  }),
              SizedBox(
