        ...
        child: Column(
          ...
          children: [
            ...
            const Divider(height: 40, thickness: 1, color: Colors.grey),
             InvoiceAmountDetail(label: 'Paid Amount', value: 'Rs. ${homeController.userHomeData!.userAllPlans[0].priceData!.priceAmount}'),
             InvoiceAmountDetail(label: 'Sub Total', value: 'Rs. ${homeController.userHomeData!.userAllPlans[0].priceData!.priceAmount}'),
            const InvoiceAmountDetail(label: 'Tax', value: 'Rs. 00'),
             InvoiceAmountDetail(
              label: 'Total',
              value: 'Rs. ${homeController.userHomeData!.userAllPlans[0].priceData!.priceAmount}',
              isBold: true,
            ),
            const SizedBox(height: 24),
            // Center(
